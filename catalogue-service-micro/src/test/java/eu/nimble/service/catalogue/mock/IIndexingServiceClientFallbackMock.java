...
@Profile("test")
@Component
public class IIndexingServiceClientFallbackMock extends IIndexingServiceClientFallback {
    private static Logger log = LoggerFactory.getLogger(IIndexingServiceClientFallbackMock.class);
    ...
    private String getSearchClassResponse(String query) throws IOException {
        if(query.contentEquals("{\"rows\":2147483647,\"start\":0,\"q\":\"id:\\\"http://www.nimble-project.org/resource/eclass#0173-1#01-AAC168#005\\\" \"}")){
            return IOUtils.toString(IIndexingServiceClientFallbackMock.class.getResourceAsStream("/mock/indexing-service/search_class_0173-1#01-AAC168#005.json"));
        }
            ...
            return IOUtils.toString(IIndexingServiceClientFallbackMock.class.getResourceAsStream("/mock/indexing-service/search_class_0173-1#01-BAA975#013.json"));
        }
            ...
            return IOUtils.toString(IIndexingServiceClientFallbackMock.class.getResourceAsStream("/mock/indexing-service/search_class_0173-1#01-AKJ050#013.json"));
        }
            ...
            return IOUtils.toString(IIndexingServiceClientFallbackMock.class.getResourceAsStream("/mock/indexing-service/search_class_0173-1#01-ACH237#011.json"));
        }
            ...
            return IOUtils.toString(IIndexingServiceClientFallbackMock.class.getResourceAsStream("/mock/indexing-service/search_class_three_uris.json"));
        }
            ...
            return IOUtils.toString(IIndexingServiceClientFallbackMock.class.getResourceAsStream("/mock/indexing-service/search_class_0173-1#01-AAA647#005.json"));
        }
            ...
            return IOUtils.toString(IIndexingServiceClientFallbackMock.class.getResourceAsStream("/mock/indexing-service/search_class_0173-1#01-AJZ801#008.json"));
        }
            ...
            return IOUtils.toString(IIndexingServiceClientFallbackMock.class.getResourceAsStream("/mock/indexing-service/search_class_0173-1#01-AKJ049#008.json"));
        }
            ...
            return IOUtils.toString(IIndexingServiceClientFallbackMock.class.getResourceAsStream("/mock/indexing-service/search_class_two_uris.json"));
        }
            ...
            return IOUtils.toString(IIndexingServiceClientFallbackMock.class.getResourceAsStream("/mock/indexing-service/search_class_road_transport_service.json"));
        }
            ...
            return IOUtils.toString(IIndexingServiceClientFallbackMock.class.getResourceAsStream("/mock/indexing-service/search_class_transport_logistics_service.json"));
        }
            ...
            return IOUtils.toString(IIndexingServiceClientFallbackMock.class.getResourceAsStream("/mock/indexing-service/search_class_logistics_service.json"));
        }
            ...
            return IOUtils.toString(IIndexingServiceClientFallbackMock.class.getResourceAsStream("/mock/indexing-service/search_class_transport_service.json"));
        }
        return null;
    }
    ...
    private String getSelectClassResponse(String query) throws IOException {
        if(query.contentEquals("_text_:die AND((nameSpace:\"http://www.nimble-project.org/resource/eclass#\" AND level:4))")){
            return IOUtils.toString(IIndexingServiceClientFallbackMock.class.getResourceAsStream("/mock/indexing-service/select_class_die.json"));
        }
            ...
            return IOUtils.toString(IIndexingServiceClientFallbackMock.class.getResourceAsStream("/mock/indexing-service/select_class_warehouse.json"));
        }
        else if(query.contentEquals("_text_:mdf AND((nameSpace:\"http://www.nimble-project.org/resource/eclass#\" AND level:4 AND code:14*))")){
            return IOUtils.toString(IIndexingServiceClientFallbackMock.class.getResourceAsStream("/mock/indexing-service/select_class_mdf.json"));
        }
        return null;
    }
    ...
    private String getPropertiesResponse(String uri) throws IOException {
        if(uri.contentEquals("http://www.nimble-project.org/resource/eclass#0173-1#01-BAA975#013")){
            return IOUtils.toString(IIndexingServiceClientFallbackMock.class.getResourceAsStream("/mock/indexing-service/get_properties_0173-1#01-BAA975#013.json"));
        }
        else if(uri.contentEquals("http://www.nimble-project.org/resource/eclass#0173-1#01-AKJ050#013")){
            return IOUtils.toString(IIndexingServiceClientFallbackMock.class.getResourceAsStream("/mock/indexing-service/get_properties_0173-1#01-AKJ050#013.json"));
        }
        else if(uri.contentEquals("http://www.nimble-project.org/resource/eclass#0173-1#01-ACH237#011")){
            return IOUtils.toString(IIndexingServiceClientFallbackMock.class.getResourceAsStream("/mock/indexing-service/get_properties_0173-1#01-ACH237#011.json"));
        }
        else if(uri.contentEquals("http://www.aidimme.es/FurnitureSectorOntology.owl#RoadTransportService")){
            return IOUtils.toString(IIndexingServiceClientFallbackMock.class.getResourceAsStream("/mock/indexing-service/get_properties_road_tranport_service.json"));
        }
        return null;
    }
