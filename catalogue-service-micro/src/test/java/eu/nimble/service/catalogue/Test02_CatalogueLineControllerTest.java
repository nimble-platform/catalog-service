...
public class Test02_CatalogueLineControllerTest {
    ...
    public void test1_addCatalogueLine() throws Exception{
        ...
        // TODO not ignore unknown properties. It is ignored because of the "orderableUnit" field generated by the front-end
        ObjectMapper ignoringMapper = new ObjectMapper().configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
        CatalogueLineType catalogueLine = ignoringMapper.readValue(catalogueLineJson, CatalogueLineType.class);
        catalogueLine.getGoodsItem().getItem().getCatalogueDocumentReference().setID(catalogue.getID());
        catalogueLineJson = ignoringMapper.writeValueAsString(catalogueLine);
