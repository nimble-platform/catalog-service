 ...
 */
public class SemanticTransformationUtil {
    private static final Logger logger = LoggerFactory.getLogger(SemanticTransformationUtil.class);
...
//    }
    ...
    public XML2OWLMapper transformCatalogueToRDF(CatalogueType catalogue) {
...
//            marsh.marshal(element, serializedCatalogueWriter);
            ...
            throw new RuntimeException("Failed to serialize the catalogue instance to XML", e);
        }
...
//            catalogueRDFWriter.flush();
            ...
            throw new RuntimeException("Failed to convert catalogue with uuid " + catalogue.getUUID() + " to RDF", e);
        }
    }
