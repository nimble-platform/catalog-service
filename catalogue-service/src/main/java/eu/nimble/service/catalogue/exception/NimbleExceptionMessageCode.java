...
public enum NimbleExceptionMessageCode {
    ...
    BAD_REQUEST_INVALID_MODIFICATION_DATE("BAD_REQUEST.invalidModificationDate"),
    BAD_REQUEST_NO_METADATA_OR_MODIFICATION_DATE("BAD_REQUEST.noMetadataOrModificationDate"),
    ...
    INTERNAL_SERVER_ERROR_FAILED_TO_ADD_LAST_SEEN_DEMAND("INTERNAL_SERVER_ERROR.failedToAddLastSeenDemand"),
    INTERNAL_SERVER_ERROR_FAILED_CREATE_DEMAND("INTERNAL_SERVER_ERROR.failedToCreateDemand"),
    INTERNAL_SERVER_ERROR_FAILED_DELETE_DEMAND("INTERNAL_SERVER_ERROR.failedToDeleteDemand"),
    ...
    INTERNAL_SERVER_ERROR_FAILED_TO_GET_DEMANDS("INTERNAL_SERVER_ERROR.failedToGetDemands"),
    INTERNAL_SERVER_ERROR_FAILED_TO_GET_DEMAND_FACETS("INTERNAL_SERVER_ERROR.failedToGetDemandFacets"),
    INTERNAL_SERVER_ERROR_FAILED_TO_GET_DEMAND_LAST_SEEN_RESPONSE("INTERNAL_SERVER_ERROR.failedToGetDemandLastSeenResponse"),
    INTERNAL_SERVER_ERROR_FAILED_TO_GET_INTEREST_COUNTS("INTERNAL_SERVER_ERROR.failedToGetDemandInterestCounts"),
    INTERNAL_SERVER_ERROR_FAILED_TO_SAVE_DEMAND_INTEREST_ACTIVITY("INTERNAL_SERVER_ERROR.failedToSaveDemandInterestActivity"),
    INTERNAL_SERVER_ERROR_FAILED_TO_SUBMIT_DEMAND_RESPONSE("INTERNAL_SERVER_ERROR.failedToSubmitDemandResponse"),
    INTERNAL_SERVER_ERROR_FAILED_TO_GET_DEMAND_RESPONSES("INTERNAL_SERVER_ERROR.failedToGetDemandResponses"),
    INTERNAL_SERVER_ERROR_FAILED_TO_DELETE_DEMAND_RESPONSE("INTERNAL_SERVER_ERROR.failedToDeleteDemandResponse"),
    NOT_FOUND_NO_DEMAND_RESPONSE("NOT_FOUND.noDemandResponse"),
    FORBIDDEN_CANNOT_RESPOND_TO_OWN_DEMAND("FORBIDDEN.cannotRespondToOwnDemand"),
    FORBIDDEN_CANNOT_DELETE_DEMAND_RESPONSE("FORBIDDEN.cannotDeleteDemandResponse"),
    FORBIDDEN_CANNOT_VIEW_DEMAND_RESPONSES("FORBIDDEN.cannotViewDemandResponses"),
    FORBIDDEN_CANNOT_SUBMIT_OTHERS_PRODUCT("FORBIDDEN.cannotSubmitOthersProduct"),
    CONFLICT_DEMAND_RESPONSE_ALREADY_EXISTS("CONFLICT.demandResponseAlreadyExists"),
    ...
    INTERNAL_SERVER_ERROR_FAILED_UPDATE_DEMAND("INTERNAL_SERVER_ERROR.failedToUpdateDemand"),
    ...
    NOT_FOUND_NO_DEMAND("NOT_FOUND.noDemandExists"),
    ...
    UNAUTHORIZER_INVALID_AUTHORIZATION("UNAUTHORIZED.invalidAuthorization"),
