...
) AS SELECT * FROM CSVREAD('{dataPath}/One-eClass-10_0_CC_en.csv', null, 'charset=UTF-8 fieldSeparator=;');
...
) AS SELECT * FROM CSVREAD('{dataPath}/One-eClass-10_0_UN_en.csv', null, 'charset=UTF-8 fieldSeparator=;');
...
) AS SELECT * FROM CSVREAD('{dataPath}/One-eClass-10_0_PR_en.csv', null, 'charset=UTF-8 fieldSeparator=;');
...
) AS SELECT * FROM CSVREAD('{dataPath}/One-eClass-10_0_KWSY_en.csv', null, 'charset=UTF-8 fieldSeparator=;');
...
CREATE TABLE eClass_Value (
	...
	DataType VARCHAR(19)
) AS SELECT * FROM CSVREAD('{dataPath}/One-eClass-10_0_VA_en.csv', null, 'charset=UTF-8 fieldSeparator=;');
...
) AS SELECT * FROM CSVREAD('{dataPath}/One-eClass-10_0_CC_PR_en.csv', null, 'charset=UTF-8 fieldSeparator=;');
...
) AS SELECT * FROM CSVREAD('{dataPath}/One-eClass-10_0_CC_PR_VA_suggested_incl_constraints_en.csv', null, 'charset=UTF-8 fieldSeparator=;');
...
) AS SELECT * FROM CSVREAD('{dataPath}/One-eClass-10_0_PR_VA_restricted_en.csv', null, 'charset=UTF-8 fieldSeparator=;');